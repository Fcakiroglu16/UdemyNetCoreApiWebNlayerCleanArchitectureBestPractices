    ...
    : ICategoryService
{
    ...
    public async Task<ServiceResult<CategoryDto>> GetByIdAsync(int id)
    {
        ...
        if (category is null) return ServiceResult<CategoryDto>.Fail("kategori bulunamadı.", HttpStatusCode.NotFound);
    ...
    public async Task<ServiceResult> UpdateAsync(int id, UpdateCategoryRequest request)
    {
        ...
        if (isCategoryNameExist) return ServiceResult.Fail("kategori ismi veritabanında bulunmaktadır.");
